...
COUNT_STMT = """SELECT COUNT(*) FROM workload_test.cluster_statement_statistics WHERE test_run=%s AND aggregated_ts>= %s AND aggregated_ts< %s"""
COUNT_TXN  = """SELECT COUNT(*) FROM workload_test.cluster_transaction_statistics WHERE test_run=%s AND aggregated_ts>= %s AND aggregated_ts< %s"""
